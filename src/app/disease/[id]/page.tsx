      ...
      <div className="rounded-3xl bg-white border border-slate-200 p-6 sm:p-8 shadow-sm">
        ...
        {disease.id === "osteoporosis" && (
          <div className="mt-6 w-full">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img 
              src="/osteoporosis-detail.png" 
              alt="골다공증 손 뼈의 변화 해부도" 
              className="w-full h-auto rounded-2xl border border-slate-200"
            />
          </div>
        )}
        ...
        {disease.id === "knee-arthritis" && (
          <div className="mt-6 w-full">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img 
              src="/knee-arthritis.jpg" 
              alt="퇴행성 슬관절염 진행 단계 해부도" 
              className="w-full h-auto rounded-2xl border border-slate-200"
            />
          </div>
        )}
        {disease.id === "cartilage-defect" && (
          <div className="mt-6 w-full">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img 
              src="/cartilage-defect.png" 
              alt="무릎 연골 결손 진행 단계 해부도" 
              className="w-full h-auto rounded-2xl border border-slate-200"
            />
          </div>
        )}
        ...
        {disease.id === "ankle-sprain" && (
          <div className="mt-6 w-full">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img 
              src="/ankle-sprain.jpg" 
              alt="발목 염좌 해부도" 
              className="w-full h-auto rounded-2xl border border-slate-200"
            />
          </div>
        ...
        {disease.id === "hallux-valgus" && (
          <div className="mt-6 flex flex-col sm:flex-row gap-4 w-full">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img 
              src="/hallux-valgus-left-v2.jpg" 
              alt="무지외반증1" 
              className="w-full sm:w-1/2 h-auto rounded-2xl border border-slate-200 object-cover"
            />
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img 
              src="/hallux-valgus-right-v2.jpg" 
              alt="무지외반증2" 
              className="w-full sm:w-1/2 h-auto rounded-2xl border border-slate-200 object-cover"
            />
          </div>
